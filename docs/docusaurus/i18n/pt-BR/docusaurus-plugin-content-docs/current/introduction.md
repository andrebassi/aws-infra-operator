---
title: 'Introdução'
description: 'Gerencie infraestrutura AWS como operador Kubernetes ou CLI standalone'
slug: /
sidebar_position: 1
---
...
- [Instalação](/installation) - Instalar como operador Kubernetes ou CLI
- [Modo CLI](/features/cli) - Usar sem Kubernetes
